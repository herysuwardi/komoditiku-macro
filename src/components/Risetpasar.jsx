        ...
        <div>            
            ...
            <Container>
                ...
                <div className="text-courses text-center">
                    ...
                    <Link className="btn-ink ms-5" to={RISETPASAR}>Riset Pasar</Link>
                ...
                <div className="wrapper__kursusonline">
                    <div className="row">
                        <div className="col-md-4">
                            <div className="card__courses">
                                <div className="card-inkursus text-center">
                                    <img src="/assets/kursus10.png" height="230" width="330" alt="..." />
                                    <h5 className="container font-weight-bold text-center mt-4 mb-5">Memahami pentingnya riset pasar dalam membangun bisnis</h5>          
                                </div>   
                        ...
                        <div className="col-md-4">
                            <div className="card__courses">
                                <div className="card-inkursus text-center">
                                    ...
                                    <h5 className="container font-weight-bold text-center mt-4 mb-5">Cara riset market online untuk bisnis</h5>   
                                </div>   
                                <div className="row mt-3 container">
                                    <div className="col-2">
                        ...
                        <div className="col-md-4">
                            <div className="card__courses">
                                <div className="card-inkursus text-center">
                                    <img src="/assets/kursus12.png" height="230" width="330" alt="..." />
                                    <h5 className="container font-weight-bold text-center mt-4 mb-5">Mengetahui manfaat dari riset pasar</h5>   
                                </div>   
                                <div className="row mt-3 container">
                                    <div className="col-2">
                    ...
                    <div className="row">
                        <div className="col-md-4">
                            <div className="card__courses">
                                <div className="card-inkursus text-center">
                                    ...
                                    <h5 className="container font-weight-bold text-center mt-4 mb-5">5 hal yang perlu di perhatikan ketika melakukan riset pasar</h5>          
                                </div>   
                                <div className="row mt-3 container">
                                    <div className="col-2">
                        ...
                        <div className="col-md-4">
                            <div className="card__courses">
                                <div className="card-inkursus text-center">
                                    <img src="/assets/kursus19.png" height="230" width="330" alt="..." />
                                    <h5 className="container font-weight-bold text-center mt-4 mb-5">7 Cara riset pasar yang tepat untuk keputusan bisnis</h5>   
                                </div>   
                                <div className="row mt-3 container">
                                    <div className="col-2">
                        ...
                        <div className="col-md-4">
                            <div className="card__courses">
                                <div className="card-inkursus text-center">
                                    ...
                                    <h5 className="container font-weight-bold text-center mt-4 mb-5">Mengetahui tips apa saja dalam melakukan riset pasar</h5>                                  
                                </div>   
                                <div className="row mt-3 container">
                                    <div className="col-2">
